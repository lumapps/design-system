## Open PR for design-system

### General summary

3–6 tight bullet points covering:
- Which components changed and the reason (one line each)
- Any new shared infrastructure added
- One-line call-outs for non-obvious decisions (e.g. a tricky workaround)
