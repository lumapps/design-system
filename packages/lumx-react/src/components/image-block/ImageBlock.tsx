...
export const ImageBlock: Comp<ImageBlockProps> = ({
    ...
    const fillHeight = propFillHeight || thumbnailProps?.fillHeight;
    const align = propAlign || thumbnailProps?.align || DEFAULT_PROPS?.thumbnailProps?.align;
