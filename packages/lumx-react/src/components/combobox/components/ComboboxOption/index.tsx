...
import { GenericProps, LumxClassName } from '@lumx/core/js/types';
...
const COMPONENT_NAME = 'ComboboxOption';
export const COMBOBOX_OPTION_CLASSNAME: LumxClassName<typeof COMPONENT_NAME> = 'lumx-combobox-option';
export const LUMX_CLASSNAME = 'lumx-list-item';

export interface OptionContentProps<O extends object = any>
