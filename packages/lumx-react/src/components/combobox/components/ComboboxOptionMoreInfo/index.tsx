...
import { IconButton, IconButtonProps, LumxClassName, Popover, PopoverProps } from '@lumx/react';
...
const COMPONENT_NAME = 'ComboboxOptionMoreInfo';
const CLASSNAME: LumxClassName<typeof COMPONENT_NAME> = 'lumx-combobox-option-more-info';
