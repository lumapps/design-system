    ...
    describe('Props', () => {
        it('should render default', () => {
            ...
            expect(button.className).toMatchInlineSnapshot(
                `"lumx-button lumx-button--color-primary lumx-button--emphasis-high lumx-button--size-m lumx-button--theme-light lumx-button--variant-button lumx-button"`,
            );
        ...
        it('should render emphasis low', () => {
            ...
            expect(button.className).toMatchInlineSnapshot(
                `"lumx-button lumx-button--color-dark lumx-button--emphasis-low lumx-button--size-m lumx-button--variant-button lumx-button"`,
            );
        });
