...
/**
 * Test rendered DOM & clicking on the uploader
 */
export const TestRenderAndClick = {
    ...WithLabelAndIcon,
    play: async ({ canvasElement, args }: any) => {
        const uploader = queryByClassName(canvasElement, Uploader.className as string);
        expect(uploader).toBeInTheDocument();
        expect(uploader).toHaveTextContent('Pick a file');

        await userEvent.click(uploader as any);
