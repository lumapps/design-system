 ...
 * @param colorPalette The custom color palette.
 */
export function setCustomColors(sheet: CSSStyleSheet, colorPalette: ColorPalette) {
    let index = 0;
    ...
    const checkboxRules = _getCheckboxCSSRules(colorPalette, 'primary');
    ...
    const radioButtonRules = _getRadioButtonCSSRules(colorPalette, 'primary');
