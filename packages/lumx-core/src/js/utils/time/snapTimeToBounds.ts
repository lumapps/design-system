 ...
 * Inputs at/below the effective `minTime` snap up to it; inputs at/above the
 * effective `maxTime` snap down to it; otherwise returned unchanged. When no
 ...
 */
export function snapTimeToBounds(time: TimeOfDay, step: number, minTime?: Date, maxTime?: Date): TimeOfDay {
