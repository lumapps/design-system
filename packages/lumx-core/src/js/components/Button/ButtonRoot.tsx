...
import { CommonRef, GenericProps, HasTheme } from '../../types';
import { HasAriaDisabled } from '../../types/HasAriaDisabled';
...
const renderButtonWrapper: React.FC<ButtonRootProps> = (props) => {
    ...
    return <div className={wrapperClassName}>{ButtonRoot(buttonProps)}</div>;
};
 ...
 * @return Element.
 */
export const ButtonRoot = (props: BaseButtonProps) => {
    const {
