...
import * as ReactDemoPlacement from './react/placement.tsx';
import * as VueDemoDefault from './vue/default.vue';
import * as VueDemoPlacement from './vue/placement.vue';
...
<DemoBlock orientation="horizontal" vAlign="space-around" demo={{ react: ReactDemoPlacement, vue: VueDemoPlacement }} />
