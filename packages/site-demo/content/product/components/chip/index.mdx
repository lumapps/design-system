...
<DemoBlock demo="dismissible" engine={props.engine} withThemeSwitcher />
...
<DemoBlock demo="choice" engine={props.engine} withThemeSwitcher />

## Filter

Use Filter as an entry point to one or several choices. When it is active, it can have a clear button.

<DemoBlock demo="filter" engine={props.engine} withThemeSwitcher />
...
<DemoBlock demo="group" engine={props.engine} withThemeSwitcher />
