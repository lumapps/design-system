...
Use textfields with counter when users inputs length is limited.

<DemoBlock demo="character-counter" withThemeSwitcher />

### With Chips

Use textfields with chips when users inputs need to be split in distinct parts such as tag entry.
