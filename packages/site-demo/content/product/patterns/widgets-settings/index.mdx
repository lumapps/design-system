...
<i class="lumx-color-font-red-D2">
    Disclaimer: while the new DS is not implemented, some examples might seem incorrect due to various spacings included in some components.
</i>
...
<img src="assets/widget-body1x.png" srcset="assets/widget-body.png 2x" style="max-width:100%"/>
</div>
...
<div className="lumx-color-background-dark-L6 lumx-spacing-padding-vertical-huge" style="text-align:center">
<img src="assets/widget-header1x.png" srcset="assets/widget-header.png 2x" style="max-width:100%"/>
</div>
...
<div className="lumx-color-background-dark-L6 lumx-spacing-padding-vertical-huge" style="text-align:center">
<img src="assets/widget-footer1x.png" srcset="assets/widget-footer.png 2x" style="max-width:100%"/>
</div>
...
<div className="lumx-color-background-dark-L6 lumx-spacing-padding-vertical-huge" style="text-align:center">
<img src="assets/widget-advanced1x.png" srcset="assets/widget-advanced.png 2x" style="max-width:100%"/>
</div>
