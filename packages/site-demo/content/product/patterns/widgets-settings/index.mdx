...
<i class="lumx-color-font-red-D2">
...
<img src="assets/heading-spacing.png" />

### Example

<img src="assets/heading-spacing-example.png" />

## Full view

<img src="assets/full-view.png" />
...
<div className="lumx-color-background-dark-L6 lumx-spacing-padding-vertical-huge" style={{ textAlign: 'center' }}>
    <img src="assets/widget-body1x.png" srcset="assets/widget-body.png 2x" style={{ maxWidth: '100%' }} />
</div>
...
<div className="lumx-color-background-dark-L6 lumx-spacing-padding-vertical-huge" style={{ textAlign: 'center' }}>
    <img src="assets/widget-header1x.png" srcset="assets/widget-header.png 2x" style={{ maxWidth: '100%' }} />
</div>
...
<div className="lumx-color-background-dark-L6 lumx-spacing-padding-vertical-huge" style={{ textAlign: 'center' }}>
    <img src="assets/widget-footer1x.png" srcset="assets/widget-footer.png 2x" style={{ maxWidth: '100%' }} />
</div>
...
<div className="lumx-color-background-dark-L6 lumx-spacing-padding-vertical-huge" style={{ textAlign: 'center' }}>
    <img src="assets/widget-advanced1x.png" srcset="assets/widget-advanced.png 2x" style={{ maxWidth: '100%' }} />
</div>
