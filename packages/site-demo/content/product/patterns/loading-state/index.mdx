...
Use `skeleton` for pieces of UI which loading require a special traitement: people see them loading a lot of time during their journey on the app, they are the first elements to render when loading the app and so on.
