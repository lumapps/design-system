import { ColorVariantsDesignTokenGroup } from '@lumx/demo/components/design-tokens';
...
You can also define another color as primary by overriding <code>\$lumx-color-primary-{variant}</code> variable.
...
You can also define another color as secondary by overriding <code>\$lumx-color-secondary-{variant}</code> variable.
