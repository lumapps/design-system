...
<table style="text-align: left; width: 100%">
    ...
    <tbody>
        <tr>
            ...
            <td>4dp</td>
            <td><div className="lumx-color-background-blue-N" style="width: 4px; height: 4px" /></td>
        </tr>
        <tr>
            <td><strong>regular</strong></td>
            <td>8dp</td>
            <td><div className="lumx-color-background-blue-N" style="width: 8px; height: 8px" /></td>
        </tr>
        <tr>
            <td><strong>big</strong></td>
            <td>16dp</td>
            <td><div className="lumx-color-background-blue-N" style="width: 16px; height: 16px" /></td>
        </tr>
        <tr>
            <td><strong>huge</strong></td>
            <td>24dp</td>
            <td><div className="lumx-color-background-blue-N" style="width: 24px; height: 24px" /></td>
        </tr>
    </tbody>
</table>
