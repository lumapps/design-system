...
import { CLASSNAME, CheckboxLabel, CheckboxLabelProps } from './CheckboxLabel';
 ...
 */
type ISetupProps = Partial<CheckboxLabelProps>;
...
describe(`<${CheckboxLabel.displayName}>`, (): void => {
