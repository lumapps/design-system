...
(theme) => {
    ...
    return (
        <>
            <TextField label="Textfield label" value={value} onChange={setValue} theme={theme} />
        </>
    );
};
```
...
(theme) => {
    ...
    return (
        <>
            <TextField label="Textfield label" value={value} onChange={setValue} isValid={true} theme={theme} />
        </>
    );
};
```
...
(theme) => {
    ...
    return (
        <>
            <TextField label="Textfield label" value={value} onChange={setValue} hasError={true} theme={theme} />
        </>
    );
};
```
...
(theme) => {
    ...
    return (
        <>
            <TextField label="Textfield label" value={value} onChange={setValue} helper={'Helper text'} theme={theme} />
        </>
    );
};
```
