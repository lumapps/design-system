...
(theme) => (
    <>
        <Button emphasis={Emphasis.medium} color={theme === Theme.dark ? 'light' : undefined} theme={theme}>
            Default
        </Button>
...
(theme) => (
    <>
        <Button emphasis={Emphasis.low} color={theme === Theme.dark ? 'light' : undefined} theme={theme}>
            Default
        </Button>
