```javascript import
import { Autocomplete, AutocompleteMultiple, List, ListItem, Size, Size, TextField, Chip, ListDivider, Icon, ListSubheader } from 'LumX';
...
(theme) => {
    ...
    return (
        ...
        >
            <List isClickable>
                { hasSuggestions && filteredCities.map((city, index) => (
                    <List>
                        {filteredCities.map((city, index) => (
                            <ListItem
                                size={Size.tiny}
