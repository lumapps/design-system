(function IIFE() {
    ...
    function DemoDataTableController($filter, $scope) {
        ...
        function updateSort(evt, dataTableId, column) {
            vm.dataTableTbody = $filter('orderBy')(vm.dataTableTbody, column.name, column.sort === 'desc' ? true : false);
        }
    ...
    angular.module('lumx').controller('DemoDataTableController', DemoDataTableController);
})();
