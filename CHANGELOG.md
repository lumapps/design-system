...
-   `@lumx/react`:
    ...
    -   _[BREAKING]_ Externalise `@lumx/core` and `@lumx/icons` (they are now imported instead of bundled inside `@lumx/react`)
    -   Restructure dist JS chunks (improve tree shaking)
-   `@lumx/core`:
