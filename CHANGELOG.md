...
-   `@lumx/vue`:
    -   `SelectTextField`, `SelectButton`: fix `change` (and `search`) events emitted twice when an option is selected.
...
-   `@lumx/react`, `@lumx/vue`:
    -   `Link`: improve accessibility by adding underline decoration when inside a paragraph to distinguish links from surrounding text.
...
-   `@lumx/core`:
    ...
    -   Moved `TabList` and `TabPanel` from `@lumx/react`
    -   Moved `TabProvider` state logic and test utilities from `@lumx/react`
-   `@lumx/vue`:
    -   Create the `ExpansionPanel` component
...
-   `@lumx/core`:
    ...
    -   Moved `Mosaic` from `@lumx/react`
    -   Moved `ExpansionPanel` from `@lumx/react`
-   `@lumx/react`:
...
-   `@lumx/core`:
    ...
    -   Moved `List`, `ListItem` and `ListDivider` from `@lumx/react`
...
-   `@lumx/core`:
    ...
    -   _[BREAKING]_ Removed `@lumx/core/js/constants/design-tokens` (internal use only)
    -   _[BREAKING]_ Removed `getBasicClass`, `handleBasicClasses` and `resolveColorWithVariants` from exports in `@lumx/core/js/utils/classNames` (internal use only)
    -   _[BREAKING]_ Replace `fontColorClass` with `font` (or `classNames.font` in `@lumx/core/js/utils`)
    -   _[BREAKING]_ Replace `getTypographyClassName` with `typography` (or `classNames.typography` in `@lumx/core/js/utils`)
-   `@lumx/icons`
...
[Unreleased]: https://github.com/lumapps/design-system/compare/4.24.0...HEAD
[4.24.0]: https://github.com/lumapps/design-system/compare/4.23.0...4.24.0
[4.23.0]: https://github.com/lumapps/design-system/compare/4.22.0...4.23.0
[4.22.0]: https://github.com/lumapps/design-system/compare/4.21.0...4.22.0
[4.21.0]: https://github.com/lumapps/design-system/compare/4.20.0...4.21.0
[4.20.0]: https://github.com/lumapps/design-system/compare/4.19.0...4.20.0
[4.19.0]: https://github.com/lumapps/design-system/compare/4.18.0...4.19.0
[4.18.0]: https://github.com/lumapps/design-system/compare/4.17.0...4.18.0
[4.17.0]: https://github.com/lumapps/design-system/compare/4.16.0...4.17.0
[4.16.0]: https://github.com/lumapps/design-system/compare/4.15.0...4.16.0
[4.15.0]: https://github.com/lumapps/design-system/compare/4.14.0...4.15.0
[4.14.0]: https://github.com/lumapps/design-system/compare/4.13.0...4.14.0
[4.13.0]: https://github.com/lumapps/design-system/compare/4.12.1...4.13.0
...
[4.9.0]: https://github.com/lumapps/design-system/compare/4.8.1...4.9.0
[4.8.1]: https://github.com/lumapps/design-system/compare/4.8.0...4.8.1
[4.8.0]: https://github.com/lumapps/design-system/compare/4.7.1...4.8.0
[4.7.1]: https://github.com/lumapps/design-system/compare/4.7.0...4.7.1
[4.7.0]: https://github.com/lumapps/design-system/compare/4.6.0...4.7.0
[4.6.0]: https://github.com/lumapps/design-system/compare/4.5.1...4.6.0
[4.5.1]: https://github.com/lumapps/design-system/compare/4.5.0...4.5.1
[4.5.0]: https://github.com/lumapps/design-system/compare/4.4.0...4.5.0
[4.4.0]: https://github.com/lumapps/design-system/compare/4.3.1...4.4.0
[4.3.1]: https://github.com/lumapps/design-system/compare/4.3.0...4.3.1
[4.3.0]: https://github.com/lumapps/design-system/compare/4.2.0...4.3.0
[4.2.0]: https://github.com/lumapps/design-system/compare/4.1.0...4.2.0
[4.1.0]: https://github.com/lumapps/design-system/compare/4.0.0...4.1.0
