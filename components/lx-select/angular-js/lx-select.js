(function IIFE() {
  ...
  function lxSelectController(
    ...
    function _nextChoiceOnKeyDown() {
      var filteredChoices = $filter("lxSelectChoicesFilter")(
        lxSelect.choices,
        lxSelect.filter,
    ...
    function _updateModel(choice) {
      ...
      if (lxSelect.multiple) {
        ...
        var choiceIndex = _arrayObjectIndexOf(
          _modelController.$viewValue,
          choice
        );
  ...
  function lxSelectDirective() {
    ...
    return {
      ...
      templateUrl: "components/lx-select/angular-js/lx-select.html",
      transclude: {
